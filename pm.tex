...
on the shortcut network $\tilde{H}_f$. \note{Really?  I think it's the admissible network?}
...
\begin{proof}
\note{TODO add general position} %TODO general position
...
exactly one point.
\note{TODO not right for $L_1$ and $L_\infty$ squares} %TODO
...
\note{TODO just invoke persistence here? but amortized data structures\dots} %TODO

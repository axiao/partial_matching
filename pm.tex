...
The set of \emph{residual edges} is defined as
\[
...
\item
$0 \leq -e_{f'}(v) \leq -e_f(v)$ for all deficit vertices $v \in V$,
\item
if $e_f(v) = 0$ then $e_{f'}(v) = 0$, and
\item $\sum_{v \in V} |e_{f'}(v)| < \sum_{v \in V} |e_f(v)|$.
\end{enumerate}

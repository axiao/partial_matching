...
\end{enumerate}
Observe that (1-3) queries all arcs leaving $S$ to non-empty vertices, and 
(4-6) queries the length 2 or 3 paths leaving $S$ through empty vertices.
\note{correctness statement here?}

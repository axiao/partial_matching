...
\note{TODO}%TODO
\begin{enumerate}[(i)]
\item \note{TODO how? MST via BCP needs $O(n\polylog n)$ time.} %TODO
...
\item The intra-cluster matching in $T_{i^*}$ uses edges of cost at most
	$\overline{\theta} = n^q \cdot c(e_{i^*})$.
	This matching corresponds to a circulation supported on arcs of cost at
	most $\overline{\theta}$.
\end{enumerate}
\end{proof}
...
\note{TODO add in dfs description, as a subsection} %TODO
...
\note{TODO move this into a correctness lemma?} %TODO

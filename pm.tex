...
contain a cycle.
Thus, $E_{>0}(f)$ can be decomposed into a set of inclusion-maximal paths of,
...
%TODO need to bound the number of blocking flow edges
\end{proof}
...
(NN) data structures, which query the minimum reduced-cost path leaving a

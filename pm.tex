...
\newenvironment{TODO}
   {\fboxrule1.5pt\begin{center}
    ...
    {\leavevmode
     \begin{lrbox}{0\null\global\setbox\tempboxb}
     \begin{minipage}{0.9\columnwidth}
     \small\sffamily\parindent1.5em\color{TODOtxtcolor}} }
   {\end{minipage}
    \end{lrbox}
    \fcolorbox{TODOtxtcolor}{TODOcolor}{\usebox{\tempboxb}}\end{center}}
...
parameter $k \leq r$, a minimum-cost geometric partial matching of size $k$
...
\label{theorem:gmcm}
Given point sets $A, B \subset \mathbb{R}^2$ with $|A| = r \leq |B| = n$ and a
parameter $k \leq r$, a $(1+\eps)$ geometric partial matching of size $k$

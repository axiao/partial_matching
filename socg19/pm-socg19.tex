...
so that for any translation/rotation $\mathbb{T}$ of $A$, a (near) optimal
matching of $\mathbb{T}(A)$ and $B$ is in the set $\EuScript{M}$.
...
Agarwal~\etal~\cite{AFPVX17} have shown that Orlin's algorithm can be

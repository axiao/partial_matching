...
Agarwal~\etal~\cite{AFPVX17} showed that \cite{O93} can be
...
%
To solve this issue we use parametric search.  The details are omitted here.
% To solve this issue we perform a binary search on the edges $e_1, \ldots, e_{r+n-1}$ of the minimum spanning tree $T$.

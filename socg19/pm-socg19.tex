Hungarian algorithm%!TEX encoding = UTF-8 Unicode
...
\EventEditors{} \EventNoEds{2} \EventLongTitle{The 35th International Symposium
on Computational Geometry (SOCG 2019)} \EventShortTitle{SOCG 2019}
\EventAcronym{SOCG} \EventYear{2019} \EventDate{June 18--21, 2019}
\EventLocation{Portland, USA} \EventLogo{eatcs} \SeriesVolume{} \ArticleNo{1} %
Set article-no=1
...
We give an outline of the strongly polynomial algorithm for uncapacitated MCF
from Orlin~\cite{O93}.
...
\emph{Hungarian search} that raises potentials (while maintaining dual

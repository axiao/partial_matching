...
For subsequent rounds, we begin with a $2\theta$-optimal circulation $f$ in $N$.
...
therefore the time required for \textsc{Scale-Init} is $O(n)$.
...
recent blocking flow admissible (in the sense that all arcs in the path is admissible). \note{better phrasing}
Straightforward calculation verifies both properties.

...
\EventLocation{Portland, United~States}
\EventLogo{socg-logo}
\SeriesVolume{129}
\ArticleNo{6}
...
Both algorithms are based on the primal-dual flow augmentation scheme; the main improvements are involved using dynamic data structures to achieve efficient flow augmentations.
...
since we leave them untracked as described.
...
next \textsc{Scale-Init}) and whenever a node becomes alive

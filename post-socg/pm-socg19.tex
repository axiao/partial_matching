...
We update potential of alive nodes in $X$ according to the reduced cost of the path.
(We will discuss how to handle potentials of dead nodes later in the section.)
...
(and additionally, at the end of each scale).
Specifically, for a newly alive $a \in A$ we set $\pi(a) \gets \pi(s)$
and for newly alive $b \in B$ we set $\pi(b) \gets \pi(t)$.

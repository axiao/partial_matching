...
The cost \EMPH{$c(\arc{v}{w})$} of each arc $\arc{v}{w}$ is equal to $c(v, w)$ if
...
and vertices with positive (resp.\ negative) imbalance \EMPH{excess vertices} (resp.\ \EMPH{deficit vertices}).
